...
const AnnouncementsPage = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      const res = await axios.get(`https://prasan-mandal-audumbar.vercel.app/api/announcements`, {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://prasan-mandal-audumbar.vercel.app/api/announcements`, formData, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleDelete = async (id) => {
    ...
    if (!passcode) return;
    try {
      await axios.delete(`https://prasan-mandal-audumbar.vercel.app/api/announcements/${id}`, {
        headers: { 
