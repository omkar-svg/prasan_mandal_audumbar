...
const OfficersPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const [offRes, memRes] = await Promise.all([
        axios.get(`https://prasan-mandal-audumbar.vercel.app/api/officers`, config),
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://prasan-mandal-audumbar.vercel.app/api/officers`, formData, {
  ...
  const handleDelete = async (id) => {
    ...
    if (!passcode) return;
    try {
      await axios.delete(`https://prasan-mandal-audumbar.vercel.app/api/officers/${id}`, {
        headers: { 
